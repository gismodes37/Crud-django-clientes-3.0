    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.CharField(max_length=20, unique=True)),
                ('nombre', models.CharField(max_length=100)),
                ('familia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subfamilias', to='agenda.familia')),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
            fields=[
                ...
                ('subfamilia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='productos', to='agenda.subfamilia')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='agenda.producto')),
